...
Q2="CREATE TABLE Post(user_id INT NOT NULL,post_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,post_content VARCHAR(500) NOT NULL);"
...
Q10="DELETE from User WHERE user_id=1;"
